...
from selfdrive.car.byd.values import CruiseButtons, CAR,   FINGERPRINTS
...
def compute_gb_byd(accel, speed):
  creep_brake = 0.0
  creep_speed = 2.3
...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=[]):  # pylint: disable=dangerous-default-value
    ...
    ret.safetyModel = car.CarParams.SafetyModel.byd
